...
public class AliAPI {
    ...
    private final String AppKey = "203963257"; // 请注意了，AppKey和AppCode不是同一个东西
    private final String AppSecret = "Refp74oW1BacnV75ZkEwA2EXunmRohZL";
    ...
    // 证件照检测接口
    private final String IDPhotoDetectAPIServer = "https://idpdetect.market.alicloudapi.com/idphoto/detect";
...
//                Log.i(TAG, "checkServerTrusted");
    ...
    // 人像扣图接口
    public Boolean imageSeg(File imageFile, String filename) {
        ...
        try {
    		...
    		*/
            ...
            //将分割后的照片保存到服务器
            DownLoadFromURL.getFile(url,filename);
...
//        System.out.println("此代码中包含多个接口调用示例，请根据自己的需求，选择不同的代码进行参考...");
//
//        AliAPI api_test = new AliAPI();
//
//        String imageFileName = "C:\\Users\\OMEN\\Desktop\\java\\java coding\\Coding\\IO\\Stream\\Pic\\5.jpg";
//
...
//        api_test.imageSeg(imageFile);
        ...
        // 证件照制作接口函数调用
//         File dstFile = new File("C:\\Users\\OMEN\\Desktop\\java\\java coding\\Coding\\IO\\Stream\\Pic\\5.png");
